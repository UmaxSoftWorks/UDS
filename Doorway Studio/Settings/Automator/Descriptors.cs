...
namespace Settings.Automator
{
    ...
    public class GlobalizedPropertyDescriptor : PropertyDescriptor
    {
        ...
        public GlobalizedPropertyDescriptor(PropertyDescriptor basePropertyDescriptor, ResourceManager Manager)
        ...
        public override string Category
        {
            get
            {
                ...
                {
                    if (oAttrib is CategoryAttribute)
                    {
                        displayName = ((CategoryAttribute) oAttrib).Category;
                    }
                    else if (oAttrib.GetType().Equals(typeof(GlobalizedPropertyAttribute)))
                    {
                ...
                string s = resourceManager.GetString(displayName);
    ...
    public class GlobalizedObject : ICustomTypeDescriptor
    {
        ...
        public PropertyDescriptorCollection GetProperties(Attribute[] attributes)
        {
            if (globalizedProps == null)
            {
                ...
                {
                    globalizedProps.Add(new GlobalizedPropertyDescriptor(oProp, resourseManager));
                }
            }
